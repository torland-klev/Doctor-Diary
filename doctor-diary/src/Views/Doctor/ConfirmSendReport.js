...
/**
This is the view where the doctor can look over the report before it is sent
to the API. It provides a view over the report where nothing can be edited.
The report that is shown is loaded from localStorage.
If the doctor wants to change something in the report, he can press the
back-button and edit.
When the send-button is pressed, a report is created with the entered data.
The report is automatically set to "Pending".
**/
