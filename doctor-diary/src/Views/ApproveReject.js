...
/**
This view shows a report to the district health officer,
and allows the report to be commented and marked as Accepted/Rejected.
When the submit-button is clicked, the report is sent to the API with
the new information.
**/
